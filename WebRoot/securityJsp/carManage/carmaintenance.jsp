    ...
    <script type="text/javascript">
        ...
        $(function () {
            grid = $('#grid')
                    .datagrid(
                            {
                                title: '',
                                url: sys.contextPath + '/car/vcarmaintenance!grid.cxl',
                                queryParams: {
        ...
        var removeFun = function (id) {
            parent.$.messager.confirm('询问', '您确定要删除此记录？', function (r) {
                if (r) {
                    $.post(sys.contextPath + '/car/carmaintenance!delete.cxl', {
                        id: id
                    }, function () {
...
<form id="searchForm">
    <table>
        <tr>
            ...
            <%
                if (securityUtil.havePermission("/car/carmaintenance!save")) {
            %>

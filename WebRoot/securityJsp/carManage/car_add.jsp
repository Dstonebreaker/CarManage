    ...
    <fieldset>
        ...
        <table class="table" style="width: 100%;">
            <tr>
                ...
                <td>车牌号:</td>
                <td><input name="car.carNo" class="easyui-validatebox textbox" data-options="required:true,validType:'maxLength[7]'"
                           style=" width: 200px;"/></td>
            </tr>
            <tr>
                <td>车辆识别号:</td>
                <td><input name="car.carIdentifyNo" class="easyui-validatebox textbox" data-options="required:true"
                           style=" width: 200px;"/></td>
                <td>发动机号:</td>
                <td><input name="car.carEngineNo" class="easyui-validatebox textbox" data-options="required:true,validType:'maxLength[20]'"
                           style=" width: 200px;"/></td>
            </tr>
            <tr>
                <td>车身颜色:</td>
            ...
            <tr>
                ...
                <td>固定使用单位:</td>
                <td><input id="car_orgIdUse" name="car.orgIdUse" style=" width: 200px;"/></td>
            </tr>
            <tr>
                <td>警牌(民牌):</td>
            ...
            <tr>
                ...
                <td><input name="car.cardId" id="cardId" style=" width: 180px;"  class="easyui-textbox"/>
                    <%
                        if (securityUtil.havePermission("dk")) {
                    %>
                    <a onclick="readCardFun();" href="javascript:void(0);" id="readcard" class="easyui-linkbutton"
                        data-options="iconCls:'ext-icon-search',plain:true">读卡</a>
                <%}%>
                </td>
                <td>库号:</td>
                <td><input name="car.carGarage" class="easyui-validatebox textbox" data-options="required:true,validType:'maxLength[10]'" style=" width: 200px;"/></td>
            </tr>
               <tr>
                <td>里程校准:</td>
            ...
            <tr>
                ...
                <td colspan="3"><input name="car.carMemo" class="easyui-textbox"
                                       data-options="multiline:true,validType:'maxLength[400]',width:'575'"

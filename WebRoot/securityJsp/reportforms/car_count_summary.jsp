...
<script type="text/javascript">
      ...
      $(function() {  
        ...
        if($("#searchForm").form("validate")){
			document.searchForm.action='<%=basePath%>car/typeCountSummaryRecord.cxl';
        ...
        function exportFile(){
        document.searchForm.action=sys.contextPath + '/export/CountSummary!doNotNeedSecurity_export.cxl';
		document.searchForm.submit();
	};
</script>
<style>
...
<body class="easyui-layout" data-options="fit:true,border:false">
	<div id="toolbar" data-options="border:true" class="datagrid-toolbar">
		<form id="searchForm" name="searchForm" method="post" target="countreport">
		...
		<div id="content" data-options="region:'center',fit:true,border:false" style="height:100%;margin:0px;padding:0px">
			<iframe name="countreport" width="100%" height="550" scrolling="auto" src="" style="border:0px"></iframe>	
	    </div>
		</form>
	</div>

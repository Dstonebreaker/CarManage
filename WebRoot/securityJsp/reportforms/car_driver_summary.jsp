...
$(function() {
 ...
 function exportFile(){
     ...
     if (endTime != "" && startTime != "" && startTime >endTime) {
        ...
        document.searchForm.action=sys.contextPath + '/export/DriverSummary!doNotNeedSecurity_export.cxl';
 ...
 function searchData(){
     ...
     if (endTime != "" && startTime != "" && startTime > endTime) {
 		...
 		document.searchForm.action='<%=basePath%>car/typeDriverSummaryRecord.cxl';
		document.searchForm.submit();
	};
    function doClear() {
  ...
  <body class="easyui-layout" data-options="fit:true,border:false">
	<div region="north" data-options="border:true" class="datagrid-toolbar">
		<table style="width:100%">
			<tr>
				<td>
				 <form id="searchForm" name="searchForm" method="post" target="driverReport">				
					<table>
						<tr>
						     <td>管理单位</td>
		...
		<div id="content" data-options="region:'center',fit:true,border:false" style="height:100%;margin:0px;padding:0px">
			...
			<iframe name="driverReport" width="100%" height="100%" scrolling="auto" src="" style="border:0px"></iframe>

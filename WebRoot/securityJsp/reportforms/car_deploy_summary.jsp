...
<script type="text/javascript">
      ...
      $(function() {  
        ...
        if($("#searchForm").form("validate")){
			document.searchForm.action='<%=basePath%>car/typeCarDelpoySummaryRecord.cxl';
        ...
        function exportFile(){
        document.searchForm.action=sys.contextPath + '/export/DelpoySummary!doNotNeedSecurity_export.cxl';
		document.searchForm.submit();
	};
</script>
<style>
...
<body class="easyui-layout" data-options="fit:true,border:false">
	<div id="toolbar" data-options="border:true" class="datagrid-toolbar">
		<form id="searchForm" name="searchForm" method="post" target="deployreport">
		  <input id="orgIdUses" name="orgIdUses" type="hidden"/>
			...
			<iframe name="deployreport" width="100%" height="550" scrolling="auto" src="" style="border:0px"></iframe>	
	    </div>
		</form>
	</div>

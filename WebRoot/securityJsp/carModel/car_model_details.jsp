		...
		<fieldset>
			...
			<table class="table" style="width: 100%;">
				<tr>
					...
					<td>车辆品牌:</td>
					<td><input id = "brand" name="carModel.dictIdBrand" readonly="readonly"/></td>
					
				</tr>
				<tr>
					<td>车系:</td>
					<td><input id ="series" name="carModel.dictIdCarSeries" readonly="readonly" /></td>
					
					<td>车型:</td>
					<td><input name="carModel.modelName" class="easyui-validatebox textbox"  data-options="required:true" readonly="readonly"/></td>
				</tr>
								<tr>
					<td>产地:</td>
					...
					<td><input name="carModel.dictIdIsT" class="easyui-combobox textbox"
						...
						" readonly="readonly"/></td>
					<td>载客量(人):</td>
					<td><input name="carModel.modelPeople" class="easyui-validatebox textbox" data-options="required:true" readonly="readonly"/></td>
				</tr>
				<tr>
					<td>载重量(吨):</td>
					<td><input name="carModel.modelLoad" class="easyui-validatebox textbox"data-options="required:true,min:0,max:200" readonly="readonly" /></td>
					<td>排气量(升):</td>
					<td><input name="carModel.modelAirDisplacement"  class="easyui-validatebox textbox"data-options="required:true,min:0,max:200" readonly="readonly"/></td>
				</tr>
				<tr> 
				<td>保养周期(月):</td>
					<td><input name="carModel.modelMaintenanceMonth" class="easyui-validatebox textbox" data-options="required:true" readonly="readonly" /></td>
					</tr>
				<tr>
					<td>备注:</td>	
				<td colspan="3"><input  name="carModel.modelMemo"   class="easyui-textbox" 	data-options="multiline:true,validType:'maxLength[400]',width:'525'" style="height:50px" readonly="readonly" /></td>	
				</tr>				
			</table>
		</fieldset>
	</form>

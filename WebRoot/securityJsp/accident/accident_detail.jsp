...
<form method="post" class="form" id="form">
	...
	<fieldset>
		...
		<tr>
			<td>车牌号:</td>
			<td>
					<input id="carNo" name="accident.carId" class="easyui-validatebox textbox" readonly="readonly" />
			</td>
			
			<td>驾驶员:</td>
			<td>
				<input id="stafNames" name="accident.stafName" class="easyui-textbox" data-options="required:true"  readonly="readonly"/>
			</td>
		...
		<tr>
			<td >事故时间:</td>
			<td>
				<input id="acciTime" name="accident.acciTime"  class="easyui-textbox" readonly="readonly"/>
			</td>
			
			<td >事故地点:</td>
			<td>
				<input id="acciAddress" name="accident.acciAddress" class="easyui-textbox" data-options="required:true" readonly="readonly"/>
			</td>
		</tr>
		<tr>
			<td >事故状态:</td>
			<td>
							<input name="accident.dictIdAcciState" id="ictIdAcciState" class="easyui-validatebox textbox" readonly="readonly"/>
			</td>
			
			<td >事故类型:</td>
			<td>
				<input id="ictIdAcciType" name="accident.dictIdAcciType" class="easyui-validatebox textbox" readonly="readonly"/>
			</td>
		</tr>
		<tr>
			<td >事故责任:</td>
			<td>
				<input id="dictIdAccidentRisk" name="accident.dictIdAccidentRisk" class="easyui-validatebox textbox"readonly="readonly" />
			</td>
			
			<td>责任比例:</td>
			<td>
				<input id="acciRiskProportion" name="accident.acciRiskProportion" type="number" class="easyui-validatebox textbox" readonly="readonly"/>
			</td>
		</tr>
		<tr>
			<td >私人理赔金额:</td>
			<td>
				<input id="acciSelfMoney" name="accident.acciSelfMoney" type="number" class="easyui-validatebox textbox" readonly="readonly"/>
			</td>
			
			<td >保险理赔金额:</td>
			<td>
				<input id="acciInsuranceMoney" name="accident.acciInsuranceMoney" type="number" class="easyui-validatebox textbox" readonly="readonly"/>
			</td>
		</tr>
		<tr>
			...
			<td >扣分:</td>
			<td  >
				<input id="acciDeductMark" name="accident.acciDeductMark" type="number"  class="easyui-validatebox textbox"readonly="readonly" />
			</td>
		</tr>
		...
		<tr>
			...
			<input id="acciExplain"  name="accident.acciExplain"  class="easyui-textbox" 
							data-options="multiline:true,validType:'maxLength[400]',width:'525'" style="height:50px" readonly="readonly"/>

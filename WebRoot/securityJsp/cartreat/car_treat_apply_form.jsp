	...
	<form method="post" class="form">
		<fieldset>
			...
			<tr>
					...
					<tr>
					<td>车型:</td>
						<td><input name="carTreat.modelName" class="easyui-validatebox textbox"  readonly="readonly" /></td>
					<td>发动机号:</td>
						<td><input name="carTreat.carEngineNo" class="easyui-validatebox textbox"  readonly="readonly" /></td>
				</tr>			
								
				<tr>
					<td>申请单位:</td>
						<td><input name="carTreat.orgName" class="easyui-validatebox textbox"  readonly="readonly" /></td>
					<td>申请时间:</td>
						<td><input name="carTreat.timeCreate" class="easyui-datebox"  readonly="readonly"/></td>
				</tr>
				...
				<td>处置方式:</td>
					<td><input id="carTreat_dictIdTreatMode" name="carTreat.dictIdTreatMode" class="easyui-combobox textbox"
						...
						" readonly="readonly"/></td>				    
					<td>处置日期:</td>
					<td><input name="carTreat.treatTime" class="easyui-datebox"  data-options="required:true" readonly="readonly" /></td>
				</tr>
				<tr>
					<td>申请人:</td>
					<td><input name="carTreat.creatUserName" class="easyui-validatebox textbox"  readonly="readonly" /></td>
					<td>处置人:</td>
					<td><input name="carTreat.treatUserName" class="easyui-validatebox textbox"    readonly="readonly"   /></td>
				
				</tr>
				<tr>
					<td>审核人:</td>
					<td><input name="carTreat.verifyUserName" class="easyui-validatebox textbox"   readonly="readonly"  /></td>
						
					<td>处置结果:</td>
					<td><input name="carTreat.resultName" class="easyui-validatebox textbox"   readonly="readonly"  /></td>
				...
				<tr>
					...
					<td colspan="3"><input name="carTreat.treatReason" class="easyui-textbox" 
								data-options="multiline:true,validType:'maxLength[400]',width:'540'" style="height:50px" readonly="readonly" /></td>	
					</tr>			

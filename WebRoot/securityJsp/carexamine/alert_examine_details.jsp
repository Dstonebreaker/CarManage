			...
			$.post(sys.contextPath + '/car/Examine!getAlertById.cxl', {
				...
				if (result.examId != undefined) {
					...
					$('form').form('load', {
						...
						'carExamine.day':result.day,
						'carExamine.nextExamTime':result.nextEaxmTime
			...
			<table class="table" style="width: 100%;">
				<tr>
					...
					data-options="panelHeight:'200',required:true,editable:false,
						valueField: 'carId',
						textField: 'carNo',
						url: sys.contextPath+'/car/carManage!doNotNeedSecurity_getcarList.cxl'
				...
				<td>金额:</td>
					...
					<td>到审天数：</td>	
					<td><input name="carExamine.day" class="easyui-validatebox textbox" data-options="required:true" readonly="readonly" /></td>					
				</tr>
				<tr>
				<td>下一次年审日期:</td>
					<td><input name="carExamine.nextExamTime" class="easyui-datebox textbox" data-options="required:true,editable:false" readonly="readonly" /></td>					
				</tr>
				<tr>					
					<td>备注:</td>
